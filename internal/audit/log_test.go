...
func TestLogCall_AllowedNoAuth(t *testing.T) {
	...
	l.LogCall(context.Background(), "github", "create_issue", "github-backend", true, 142, nil)
...
func TestLogCall_DeniedEntry(t *testing.T) {
	...
	l.LogCall(context.Background(), "fs", "delete_file", "fs-backend", false, 0, nil)
...
func TestLogCall_WithError(t *testing.T) {
	...
	l.LogCall(context.Background(), "github", "list_prs", "github-backend", true, 50,
...
func TestLogCall_MultipleEntriesAreNewlineSeparated(t *testing.T) {
	...
	l.LogCall(context.Background(), "ns", "tool1", "be1", true, 1, nil)
	l.LogCall(context.Background(), "ns", "tool2", "be1", false, 0, nil)
...
func TestNoop_ProducesNoOutput(t *testing.T) {
	...
	l.LogCall(context.Background(), "ns", "tool", "be", true, 0, nil)
}
